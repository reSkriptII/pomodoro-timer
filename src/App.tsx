...
export default function App() {
  ...
  return (
    <div className='bg-red-600 min-h-screen'>
      <HeaderBar />
      <div className='flex justify-center items-center pt-12 md:pt-28'>
        <div className='bg-red-400 md:px-20 px-4 py-8 border-x-28 border-x-yellow-400 '>
...
function HeaderBar() {
  return (
    <header className='flex justify-between max-w-screen-md p-4 md:px-16 m-auto'>
